...
namespace BeautySpaceInfrastructure.Controllers
{
    public class ServicesController : Controller
    {
        ...
        {
            var dbbeautySpaceContext = _context.Services.Include(s => s.Category);
        ...
        public async Task<IActionResult> Create([Bind("Name,Description,Price,CategoryId,Id")] Service service)
        {
